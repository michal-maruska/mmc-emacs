...
;;; Description:
;; Sometimes i must (lose synchronization with my co-workers) revert the buffer, but don't know
;; whether i made some changes:
...
(let ((map ediff-keymap))
  (global-set-key [(control ?E)] map)	;shift
